...
bip39 = ['abandon', 'ability', 'able', 'about', 'above', 'absent', 'absorb', 'abstract', 'absurd', 'abuse', 'access',
...
def get_bip39():
    ...
    phraselist = match_words(indexes)
    final_word = checksum(s)
